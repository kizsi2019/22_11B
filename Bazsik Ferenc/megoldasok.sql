...
DEFADULT CHARACTER SET utf8
COLLATE utf8_hungarian_ci;

-- 3. feladat:
UPDATE nagydijak
SET korokszama = '70' 
WHERE nagydijak.id = 12;

-- 4. feladat:
SELECT pilotak.vezeteknev,pilotak.rajtszam,pilotak.csapatnev,2019-year(pilotak.szuletesidatum)
AS eletkor 
FROM pilotak
...
-- 6. feladat:
SELECT concat(pilotak.keresztnev," ",pilotak.vezeteknev) 
AS nev,pilotak.csapatnev
SUM(eredmenyek.pontszam) 
AS osszpontszam
FROM pilotak 
