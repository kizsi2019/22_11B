...
b,SELECT AVG(standard_cost)AS Átlag FROM `products` WHERE list_price BETWEEN 20 AND 50;

c,SELECT AVG(standard_cost)AS Átlag FROM `products` WHERE category NOT LIKE'Sauces';
